...
public interface Point3DRepository extends CrudRepository<Point3D, UUID> {
    ...
    @Query(value = "select cast(a.id as varchar) as pointid, cast(b.id as varchar) as polyid, ST_Relate(a.geometry, b.geometry) from #{#entityName} a, terraintwinv2.point_3d b", nativeQuery = true)
