...
create table if not exists terraintwinv2.point_2d (id uuid PRIMARY KEY , point_id int, geometry geometry(POINT,25832));

create table if not exists terraintwinv2.point_3d (id uuid PRIMARY KEY , point_id int, geometry geometry(POINTZ,25832));

create table if not exists terraintwinv2.line_2d (id uuid PRIMARY KEY , line_id int, geometry geometry(LINESTRING,25832));

create table if not exists terraintwinv2.line_3d (id uuid PRIMARY KEY , line_id int, geometry geometry(LINESTRINGZ,25832));

create table if not exists terraintwinv2.polygon_2d (id uuid PRIMARY KEY , polygon_id int, geometry geometry(POLYGON,25832));

create table if not exists terraintwinv2.polygon_3d (id uuid PRIMARY KEY , polygon_id int, geometry geometry(POLYGONZ,25832));
